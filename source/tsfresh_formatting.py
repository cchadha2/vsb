...
amplitude = pd.DataFrame(train_sig.stack().reset_index().drop('level_0', axis=1).rename(columns={'level_1':'signal_id'}))
...
tsfresh_df.to_csv('../output/train_sig_2500Hz_4th_order_dwt_tsfresh_format.csv', index=False)